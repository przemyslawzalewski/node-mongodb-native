...
const read_preference_1 = require("../topologies/read_preference");
...
exports.MESSAGE_HEADER_SIZE = 16;
exports.COMPRESSION_DETAILS_SIZE = 9; // originalOpcode + uncompressedSize, compressorID
// OPCODE Numbers
...
function getReadPreference(cmd, options) {
    ...
    var readPreference = cmd.readPreference || new read_preference_1.ReadPreference('primary');
    // If we have an option readPreference override the command one
    if (options.readPreference) {
        readPreference = options.readPreference;
    }
    if (typeof readPreference === 'string') {
        readPreference = new read_preference_1.ReadPreference(readPreference);
    }
